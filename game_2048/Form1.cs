...
namespace game_2048
{
    public partial class Form1 : Form
    {
        ...
        private void CreateMap()
        {
            for (int i = 0; i < 4; i++)
            {
                for (int j = 0; j < 4; j++)
                {
                    ...
                    pic.Location = new Point(22 + 96 * j, 101 + 96 * i);
        ...
        private void GenerateNewPic()
        {
            ...
            labels[a, b].Text = "2";
            labels[a, b].Size = new Size(90, 90);
            ...
            pics[a, b].Location = new Point(22 + b * 96, 101 + 96 * a);
            pics[a, b].Size = new Size(90, 90);
            pics[a, b].BackColor = Color.Orange;
        ...
        private void CreatePics()
        {
            ...
            labels[0, 0].Text = "2";
            labels[0, 0].Size = new Size(90, 90);
            ...
            pics[0, 0].Location = new Point(22, 101);
            pics[0, 0].Size = new Size(90, 90);
            pics[0, 0].BackColor = Color.Orange;
            ...
            labels[0, 1].Text = "2";
            labels[0, 1].Size = new Size(90, 90);
            labels[0, 1].TextAlign = ContentAlignment.MiddleCenter;
            labels[0, 1].Font = new Font(new FontFamily("Microsoft Sans Serif"), 16);
            pics[0, 1].Controls.Add(labels[0, 1]);
            pics[0, 1].Location = new Point(118, 101);
            pics[0, 1].Size = new Size(90, 90);
            pics[0, 1].BackColor = Color.Orange;
        ...
        {
            if (sum % 1024 == 0) pics[k, j].BackColor = Color.Crimson;
            else if (sum % 512 == 0) pics[k, j].BackColor = Color.Fuchsia;
            else if (sum % 256 == 0) pics[k, j].BackColor = Color.DarkViolet;
            else if (sum % 128 == 0) pics[k, j].BackColor = Color.Blue;
            else if (sum % 64 == 0) pics[k, j].BackColor = Color.DeepSkyBlue;
            else if (sum % 32 == 0) pics[k, j].BackColor = Color.GreenYellow;
            else if (sum % 16 == 0) pics[k, j].BackColor = Color.Cyan;
            else if (sum % 8 == 0) pics[k, j].BackColor = Color.Red;
            else pics[k, j].BackColor = Color.Lime;
        }
                            ...
                            if (map[k, l] == 1)
                            {
                                for (int j = l + 1; j < 4; j++)
                                {
                                    if (map[k, j] == 0)
                                    {
                                        ...
                                        labels[k, j - 1] = null;
                                        pics[k, j].Location = new Point(pics[k, j].Location.X + 96, pics[k, j].Location.Y);
                                    }
                                    else
                                    {
                            ...
                            if (map[k, l] == 1)
                            {
                                for (int j = k + 1; j < 4; j++)
                                {
                                    if (map[j, l] == 0)
                                    {
                                        ...
                                        labels[j - 1, l] = null;
                                        pics[j, l].Location = new Point(pics[j, l].Location.X, pics[j, l].Location.Y + 96);
                                    }
                                    else
                                    {
